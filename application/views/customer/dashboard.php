            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        <li class="nav-item"><a class="nav-link active" aria-current="page" href="<?php echo base_url('customer/dashboard')?>">Beranda</a></li>
                            ...
                            <div class="card h-100">
                                ...
                                <div class="text-center card-footer p-2">
                                    ...
                                    if ($mb->status == "1") {
                                        ...
                                        <span
                                        class="btn btn-warning">Rental</span>'
                                    );
                                    }else {
                                        echo "<span class='btn btn-warning'>Tidak Tersedia</span>";
