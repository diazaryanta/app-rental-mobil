    ...
    <form method="POST" action="<?php echo base_url('admin/data_customer/update_customer_aksi') ?>">
        ...
        <div class="form-group">
            ...
            <select class="form-control" name="gender">
                <option value="<?php echo $cs->id_customer ?>"><?php echo $cs->gender ?></option>
        ...
        <div class="form-group">
            ...
            <input type="text" name="no_telefon" class="form-control" value="<?php echo $cs->no_telefon ?>">
            <?php echo form_error('no_telefon','<span class="text-small text-danger">','</span>') ?>
        </div>
